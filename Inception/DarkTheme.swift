...
class DarkTheme : Theme {
    ...
    var darkerTextColor = UIColor.lightTextColor()
    var seasonNavigatorBackgroundColor = UIColor.darkTextColor()
    var trailStrokeColor = UIColor.whiteColor()
    var copyrightImageString = "tmdb"
}